...
const aliases = { 'polymeric-sand-replacement':'pressure-washing', 'deck-refinishing':'deck-staining', 'gutter-services':'gutter-cleaning' };
...
http.createServer((req,res) => {
  ...
  if (alias && aliases[alias[2]]) { res.writeHead(301,{Location:`${alias[1] || ''}/services/${aliases[alias[2]]}${url.search}`}); return res.end(); }
