...
const info: Record<Locale, Record<PageName, [string, string]>> = {
  en: {
    home: ['Home Maintenance in Montréal', 'Owner-operated home maintenance in Montréal: window, gutter and dryer vent cleaning, polymeric sand, pressure washing, and deck sanding and staining. Free quotes.'],
  ...
  fr: {
    home: ['Entretien de maison à Montréal', 'Entretien de maison par les propriétaires à Montréal : vitres, gouttières, conduits de sécheuse, sable polymère, lavage à pression, sablage et teinture de terrasses. Soumissions gratuites.'],
    ...
    terms: ['Conditions de service', 'Renseignements sur les demandes de service EDMTL, les soumissions gratuites, les modes de paiement et les coordonnées de notre équipe.'],
