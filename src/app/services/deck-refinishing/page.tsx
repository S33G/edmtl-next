      ...
      <div className="relative bg-[var(--background)]/80 dark:bg-gray-900/80 backdrop-blur-md shadow-sm border-b border-[var(--border-light)] dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <Link
              href="/"
              className="flex items-center space-x-2 text-[var(--text-muted)] dark:text-gray-300 hover:text-[var(--primary)] dark:hover:text-blue-400 transition-colors duration-200"
            >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">Chemical Brightening</h3>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">Waterproofing</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 text-sm">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">Sanding Prep</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 text-sm">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">Stain Application</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 text-sm">
        ...
        <div className="bg-gradient-to-r from-amber-50 to-orange-50 border border-amber-200 rounded-2xl p-8 mb-16">
          <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6 text-center">Why Refinish Instead of Replace?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">💰</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Save Thousands</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">With lumber and labor costs, a new deck is a significant purchase. Refinishing costs a fraction of replacement.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">🛡️</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Prevent Rot</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">After many years, outdoor wood will rot if left untreated. Regular treatment prevents this expensive problem.</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-amber-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-2xl">✨</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Restore Beauty</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Transform grey, weathered wood back to a vibrant, attractive living space that adds value to your home.</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-12 mb-16">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">Chemical Brightening</h2>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Cost-effective color recovery</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Professional brightening chemicals</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Low-pressure washing application</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Significant improvement with minimal effort</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-4">Best For:</h3>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">Waterproofing Treatment</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Preserves natural wood appearance</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Prevents water absorption</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">UV fade protection</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Quick application with paint roller</span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">Sanding Preparation</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Complete surface sanding</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Detail sanders for tight areas</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Dremel tools for intricate spaces</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Ensures proper stain adhesion</span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">Stain Application</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Protects wood from rot and weather</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Revitalizes faded wood color</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Multiple transparency options</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Custom color consultation</span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8 mb-16">
          <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-8 text-center">Our Deck Refinishing Process</h2>
          <div className="grid md:grid-cols-5 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Assessment</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Evaluate deck condition and determine best treatment method</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[var(--primary)] dark:text-blue-400">2</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Cleaning</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Deep clean and prepare surface for treatment</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[var(--primary)] dark:text-blue-400">3</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Sanding</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Thorough sanding including all detail areas</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[var(--primary)] dark:text-blue-400">4</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Treatment</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Apply chosen stain, sealant, or waterproofing</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[var(--primary)] dark:text-blue-400">5</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Final Inspection</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Quality check and cleanup for perfect results</p>
            </div>
          </div>
        </div>
