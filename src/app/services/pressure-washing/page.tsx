      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">Pressure Washing</h3>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">High-Pressure</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 text-sm">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">Low-Pressure</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 text-sm">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 className="text-lg font-semibold text-[var(--foreground)] dark:text-white mb-3">Polymeric Sand</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 text-sm">
        ...
        <div className="space-y-12 mb-16">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">Professional Pressure Washing</h2>
                ...
                <div>
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      ...
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Extensive experience with various surfaces</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Proper pressure selection for each surface</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Professional safety protocols</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Trusted by property owners</span>
                    </li>
                  </ul>
                </div>
                <div className="bg-gray-50 rounded-xl p-6">
                  <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-4">Surfaces We Clean</h3>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">High-Pressure Surface Washing</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">High pressure (3000-4000 PSI) capability</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Surface washer attachment for large areas</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Pre-wash and degreaser application</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Efficient cleaning of parking garages</span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">Low-Pressure Surface Washing</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Low pressure (~1600 PSI) for delicate surfaces</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Soft-wash chemical applications</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Hand washing when appropriate</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Surface-appropriate cleaning methods</span>
                    </li>
                  </ul>
                </div>
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 overflow-hidden">
            <div className="p-8">
              <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-6">Polymeric Sand Removal & Installation</h2>
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
                  ...
                  <ul className="space-y-3">
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Professional sand removal and installation</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Proper depth and amount calculation</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Compacting plate vibration</span>
                    </li>
                    <li className="flex items-start">
                      <HiCheckCircle className="w-5 h-5 text-green-500 mr-3 mt-0.5 flex-shrink-0" />
                      <span className="text-[var(--text-muted)] dark:text-gray-300">Dramatically improved appearance</span>
                    </li>
                  </ul>
                </div>
        ...
        <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8 mb-16">
          <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-8 text-center">Why Choose EDM Pressure Washing?</h2>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Right Equipment</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">From low pressure (1600 PSI) to high pressure (3000-4000 PSI), we have the right tools for every surface</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <HiBeaker className="w-8 h-8 text-[var(--primary)] dark:text-blue-400" />
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Extensive Experience</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">After many years, we always know the appropriate method to choose for each unique situation</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <HiCheckCircle className="w-8 h-8 text-[var(--primary)] dark:text-blue-400" />
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Trusted Results</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Clear communication, fixed-price quotes, and showing up on time with efficient, thorough work</p>
            </div>
          </div>
        </div>
