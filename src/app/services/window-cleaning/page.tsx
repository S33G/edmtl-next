...
export default function WindowCleaningPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[var(--background)] to-[var(--background-secondary)] dark:from-gray-900 dark:to-gray-800 transition-colors duration-300">
      {/* Header */}
      <div className="relative bg-[var(--background-tertiary)]/80 dark:bg-gray-800/80 backdrop-blur-md shadow-sm border-b border-[var(--border-light)] dark:border-gray-700">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-white mb-4">Interior Cleaning</h3>
            ...
            <ul className="space-y-2">
              <li className="flex items-center text-sm text-[var(--text-muted)] dark:text-gray-300">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-white mb-4">Exterior Cleaning</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
          ...
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-white mb-4">Water-Fed System</h3>
            <p className="text-[var(--text-muted)] dark:text-gray-300 mb-6">
        ...
        <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8 mb-16">
          <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-white mb-8 text-center">Our Window Cleaning Process</h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">We assess your windows and determine the best cleaning method</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[var(--primary)] dark:text-blue-400">2</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Preparation</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">We protect your property and prepare our professional equipment</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Professional cleaning using appropriate techniques and equipment</p>
            </div>
            <div className="text-center">
              <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-blue-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                <span className="text-xl font-bold text-[var(--primary)] dark:text-blue-400">4</span>
              </div>
              <h3 className="font-semibold text-[var(--foreground)] dark:text-white mb-2">Inspection</h3>
              <p className="text-sm text-[var(--text-muted)] dark:text-gray-300">Final quality check to ensure perfect, streak-free results</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8">
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-white mb-6">Why Choose Our Window Cleaning?</h3>
            <ul className="space-y-3">
              <li className="flex items-start">
                <HiCheckCircle className="w-5 h-5 text-[var(--success)] dark:text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-[var(--text-muted)] dark:text-gray-300">Professional squeegee technique for streak-free results</span>
              </li>
              <li className="flex items-start">
                <HiCheckCircle className="w-5 h-5 text-[var(--success)] dark:text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-[var(--text-muted)] dark:text-gray-300">Interior and exterior cleaning available</span>
              </li>
              <li className="flex items-start">
                <HiCheckCircle className="w-5 h-5 text-[var(--success)] dark:text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-[var(--text-muted)] dark:text-gray-300">Water-fed pole system for high windows</span>
              </li>
              <li className="flex items-start">
                <HiCheckCircle className="w-5 h-5 text-[var(--success)] dark:text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-[var(--text-muted)] dark:text-gray-300">Screen and frame cleaning included</span>
              </li>
              <li className="flex items-start">
                <HiCheckCircle className="w-5 h-5 text-[var(--success)] dark:text-green-400 mr-3 mt-0.5 flex-shrink-0" />
                <span className="text-[var(--text-muted)] dark:text-gray-300">Fully insured and experienced professionals</span>
              </li>
            </ul>
          </div>

          <div className="bg-[var(--background-tertiary)] dark:bg-gray-800 rounded-2xl shadow-sm border border-[var(--border-light)] dark:border-gray-700 p-8">
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-white mb-6">Service Areas</h3>
            <div className="space-y-4">
              <div className="flex items-center text-[var(--text-muted)] dark:text-gray-300">
