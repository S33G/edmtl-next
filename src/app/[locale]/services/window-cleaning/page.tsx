    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-[var(--background-secondary)] dark:bg-[var(--background-secondary)] rounded-2xl shadow-sm border border-[var(--border)] dark:border-[var(--border)] p-8 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-[var(--foreground)] mb-4">{t.services.interior.title}</h3>
            ...
            <ul className="space-y-2">
              {t.services.interior.features.map((feature, index) => (
                <li key={index} className="flex items-center text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)]">
          ...
          <div className="bg-[var(--background-secondary)] dark:bg-[var(--background-secondary)] rounded-2xl shadow-sm border border-[var(--border)] dark:border-[var(--border)] p-8 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-[var(--foreground)] mb-4">{t.services.exterior.title}</h3>
          ...
          <div className="bg-[var(--background-secondary)] dark:bg-[var(--background-secondary)] rounded-2xl shadow-sm border border-[var(--border)] dark:border-[var(--border)] p-8 hover:shadow-lg transition-all duration-300">
            ...
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-[var(--foreground)] mb-4">{t.services.waterFed.title}</h3>
            <p className="text-[var(--text-muted)] dark:text-[var(--text-muted)] mb-6">
        ...
        {/* Process Section */}
        <div className="bg-[var(--background-secondary)] dark:bg-[var(--background-secondary)] rounded-2xl shadow-sm border border-[var(--border)] dark:border-[var(--border)] p-8 mb-16">
          <h2 className="text-2xl font-bold text-[var(--foreground)] dark:text-[var(--foreground)] mb-8 text-center">{t.process.title}</h2>
            ...
            {t.process.steps.map((step, index) => (
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-[var(--primary)]/10 dark:bg-[var(--primary)]/20 rounded-full flex items-center justify-center mx-auto mb-4">
                  <span className="text-xl font-bold text-[var(--primary)] dark:text-[var(--primary)]">{index + 1}</span>
                </div>
                <h3 className="font-semibold text-[var(--foreground)] dark:text-[var(--foreground)] mb-2">{step.title}</h3>
                <p className="text-sm text-[var(--text-muted)] dark:text-[var(--text-muted)]">{step.description}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <div className="bg-[var(--background-secondary)] dark:bg-[var(--background-secondary)] rounded-2xl shadow-sm border border-[var(--border)] dark:border-[var(--border)] p-8">
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-[var(--foreground)] mb-6">{t.features.whyChoose}</h3>
            <ul className="space-y-3">
              {t.features.reasons.map((reason, index) => (
                <li key={index} className="flex items-start">
                  ...
                  <span className="text-[var(--text-muted)] dark:text-[var(--text-muted)]">{reason}</span>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="bg-[var(--background-secondary)] dark:bg-[var(--background-secondary)] rounded-2xl shadow-sm border border-[var(--border)] dark:border-[var(--border)] p-8">
            <h3 className="text-xl font-semibold text-[var(--foreground)] dark:text-[var(--foreground)] mb-6">{t.features.serviceAreas}</h3>
            <div className="space-y-4">
              {t.features.areas.map((area, index) => (
                <div key={index} className="flex items-center text-[var(--text-muted)] dark:text-[var(--text-muted)]">
